...
public:
  ...
  void Reset ();
  int Ingest (const jhcImg& d16, int cam =0, int zst =0) 
    {return Ingest(d16, zlo, zhi, cam, zst);}
  int Ingest (const jhcImg& d16, double bot, double top, int cam =0, int zst =0);
  int Reproject (jhcImg& dest, const jhcImg& d16, int cam =0, int zst =0) 
    {return Reproject(dest, d16, zlo, zhi, cam, zst);}
  int Reproject (jhcImg& dest, const jhcImg& d16, double bot, double top, int cam =0, int zst =0);
